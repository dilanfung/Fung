...
<!--		<label>
		...
		<div id="modalEditarProveedor{{ $proveedor->id }}" class="modal modal-top fade">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<form id="add-event" method="POST" action="{{ url('/crearProveedorAdmin/'.$proveedor->id) }}">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="IdM" id="IdM" value="{{ $proveedor->id }}" readonly>
							</div>
							<div class="form-group">
								<label>Nombre</label>
								<input type="text" class="form-control" name="NombreM" id="NombreM" value="{{ $proveedor->nombre }}">
							</div>
							<div class="form-group">
								<label>Dirección</label>
								<input type="text" class="form-control" name="DireccionM" id="DireccionM" value="{{ $proveedor->direccion }}">
							</div>
							<div class="form-group">
								<label>Fecha ingreso</label>
								<input type='date' class="form-control" name="FechaM" id="FechaM" value="{{ $proveedor->fecha }}">
							</div>
							<div class="form-group">
								<label>Cédula</label>
								<input type='text' class="form-control" name="CedulaM" id="CedulaM" value="{{ $proveedor->cedula }}">
							</div>
							<div class="form-group">
